...
export interface ApiCityCity extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: '\u015Eehirler koleksiyonu - Cities collection';
    displayName: 'City';
    pluralName: 'cities';
    singularName: 'city';
  };
  ...
  attributes: {
    ...
    short_info_en: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiPlacePlace extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Mekanlar koleksiyonu - Places collection';
    displayName: 'Place';
    pluralName: 'places';
    singularName: 'place';
  };
  ...
  attributes: {
    ...
    description_tr: Schema.Attribute.Text &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
